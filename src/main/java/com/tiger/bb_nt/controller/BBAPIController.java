...
public class BBAPIController {
    ...
    public ResponseEntity<Player> player(@PathParam("id") String id, @PathParam("login") String login, @PathParam("code") String code){
        return new ResponseEntity<>(bbapiService.getPlayer(id, login, code), HttpStatus.OK);
    }

    @GetMapping(value = "/players")
    public ResponseEntity<List<Player>> players(@PathParam("login") String login, @PathParam("code") String code){
        return new ResponseEntity<>(bbapiService.getPlayers(login, code), HttpStatus.OK);
    }
